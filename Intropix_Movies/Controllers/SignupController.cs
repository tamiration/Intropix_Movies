...
namespace Intropix_Movies.Controllers
{
    public class SignupController : Controller
    {
        ...
        public SignupController(Intropix_MoviesContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Username,Password,Name,Age,EMail,RegistrationDate,Is_Manager")] User user)
        {
